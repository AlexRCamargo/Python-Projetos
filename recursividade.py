...
# fatorial(num) = num * fatorial(num -1), para num > 1 'Caso Recursivo' chama si próprio por uma versão menor do problema diversas vezes, sucessivamente. até chegar no Caso Base
